      ...
      <DialogContent className="sm:max-w-[425px]">
        <form onSubmit={handleSubmit(onSubmit)} action="">
          ...
          <div className="grid gap-8 py-4">
            <div className="w-full p-4 bg-gray-50 rounded-2xl border  border-gray-300 gap-3 border-dashed">
            ...
            <div className="flex items-center ">
              <Label htmlFor="username" className="text-start w-[80px] ">
                name
              </Label>
