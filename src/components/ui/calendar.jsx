...
function Calendar({ className, classNames, showOutsideDays = true, ...props }) {
  return (
    <DayPicker
      ...
      classNames={{
        months:
          'flex flex-col w-full h-full sm:flex-row space-y-4 sm:space-x-4 sm:space-y-0',
        ...
        day_selected:
          'bg-blue-700 text-primary-foreground hover:bg-blue-800 hover:text-primary-foreground focus:bg-blue-700 focus:text-primary-foreground',
